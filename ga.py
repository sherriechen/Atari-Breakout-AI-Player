...
class Memory(object):
	...
	def sample(self, batchSize):
		return random.sample(self.memoru, batchSize)
...
play(action):
  # Need implementation
  # Takes in an [action] (move left, move right, or not move)
  # Return: - [done]: Boolean whether game is over not
  #     - [screen]: Screenshot of the game after playing [action]
  #       - [reward]: Game score after playing [action]
  return None
